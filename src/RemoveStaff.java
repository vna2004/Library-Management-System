...
public class RemoveStaff extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Enter Staff Id / Staff Name to Delete the Staff from the Records :");

        jLabel2.setFont(new java.awt.Font("Segoe UI Historic", 1, 14)); // NOI18N
        jLabel2.setText("STAFF ID / STAFF  NAME :");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        try {
            ...
            if(rows > 0) {
                JOptionPane.showMessageDialog(this, "Staff Removed From Library Records");
            }
            else {
                JOptionPane.showMessageDialog(this, "Enter valid Details. No such Staff Available.");
            }
            t1.setText(null);
            st.close();
